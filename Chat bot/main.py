...
fish_data = load_json_file('fish.json')
marine_data = load_json_file('marine_data.json')
marine_laws = load_json_file('marine_laws.json')
...
def chat():
    ...
    # Marine life related queries
        ...
        if any(keyword in user_message for keyword in
            ...
            bot_message = "I can provide information about marine species, ecosystems, fish species, and related laws in Mauritius. Please ask me specific questions about these topics."
    else:
        ...
        try:
            ...
            bot_message = f"An error occurred while processing your request: {e}"
